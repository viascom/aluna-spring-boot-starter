...
/**
 * Interaction is an Aluna specific annotation which should be used for all DiscordCommand's as well as DiscordContextMenu's. It includes @Component and @InteractionScoped
 *
