...
public abstract class CoroutineDiscordMessageContext(name: String, localizations: LocalizationFunction? = null) : DiscordMessageContextMenuHandler(name, localizations) {
    ...
    protected abstract suspend fun execute(event: MessageContextInteractionEvent)
