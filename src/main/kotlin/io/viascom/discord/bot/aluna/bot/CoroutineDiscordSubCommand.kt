 ...
 */
public abstract class CoroutineDiscordSubCommand(name: String, description: String) : DiscordSubCommandHandler(name, description), DiscordSubCommandElement {
    ...
    public open suspend fun initCommandOptions() {}
