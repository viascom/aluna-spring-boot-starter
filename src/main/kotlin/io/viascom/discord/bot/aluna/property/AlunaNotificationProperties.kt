...
public class AlunaNotificationProperties {

    /**
     * Configuration for server join event notification
     */
    @NestedConfigurationProperty
    public var serverJoin: Notification = Notification()

    /**
     * Configuration for server leave event notification
     */
    @NestedConfigurationProperty
    public var serverLeave: Notification = Notification()

    /**
     * Configuration for bot ready event notification
     */
    @NestedConfigurationProperty
    public var botReady: Notification = Notification()
...
public class Notification {
     ...
     */
    public var server: Long? = null

    /**
     * Channel where it gets posted
     */
    public var channel: Long? = null
}
