 ...
 */
class DiscordMessageContextEvent(source: Any, val user: User, val channel: Channel?, val guild: Guild?, val name: String, val contextMenu: DiscordMessageContextMenu) :
